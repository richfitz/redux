...
##' thin wrapper around the existing R functions [serialize()] and
##' [rawToChar()].  This is useful to encode arbitrary R objects as
...
##'   [serialize()] this is disabled here by default as it is a bit
